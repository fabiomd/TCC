...
(defun apply-crossover-function (nodeA nodeB)
	(let ((multiple-nodeA (slot-value nodeA 'body))
		  (multiple-nodeB (slot-value nodeB 'body)))
	    (let ((body-A (slot-value multiple-nodeA 'body))
		      (body-B (slot-value multiple-nodeB 'body)))
